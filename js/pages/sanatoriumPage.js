class sanatoriumPage extends dynamicPage {
	...
	formAddBlock() {
		...
		var l1 = element('label', {'for':'name'}, {'margin':'5px 0'}, null, ['Название санатория:']);
		var i1 = element('input', {'name':'name','type':'text','placeholder':'Название санатория','id':'name'}, null, ["form-control"], null);
