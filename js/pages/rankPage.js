class rankPage extends dynamicPage {
	...
	formAddBlock() {
		...
		var l1 = element('label', {'for':'rankText'}, null, ["control-label"], ['Звание:']);
		var i1 = element('input', {'name':'rankText','type':'text','id':'rankText'}, {'margin-top':'5px'}, ["form-control"], null);
	...
	setEditMultipleClicker(idArr) {
		...
		var l2 = element('label', null, null, ["control-label"], ['Просмотр званий:']);
		var ops = Array();
	...
	formTableBlock() {
		var dataArr = getRequest(this.serverPageUrl,{});
		console.log(dataArr)
		var nameArr = ['ID','Звание', 'Текст QR-кода','XP','Звезды','Монеты'];
